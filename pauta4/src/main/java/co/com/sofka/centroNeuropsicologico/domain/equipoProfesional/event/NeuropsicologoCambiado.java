...
public class NeuropsicologoCambiado extends DomainEvent {
    ...
    public NeuropsicologoCambiado(NeuropsicologoId entityId, Nombre nombre, Email email, TarjetaProfesional tarjetaProfesional) {
