...
public class PsicologoCambiado extends DomainEvent {
    ...
    public PsicologoCambiado(PsicologoId entityId, Nombre nombre, Email email, TarjetaProfesional tarjetaProfesional) {
